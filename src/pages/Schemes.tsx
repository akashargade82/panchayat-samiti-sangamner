...
const ZP_DEPARTMENTS: DeptInfo[] = [
  {
    ...
    contact: [
      "मा. उप मुख्य कार्यकारी अधिकारी (सामान्य), जिल्हा परिषद अहिल्यानगर",
      "कक्ष अधिकारी, सामान्य प्रशासन विभाग १, जिल्हा परिषद अहिल्यानगर",
      "कार्यालयीन अधिक्षक, सामान्य प्रशासन विभाग १, जिल्हा परिषद अहिल्यानगर",
    ],
    phone: "०२४१ – २३५३६९५",
  },
  {
    name: "ग्रामपंचायत",
    title: "रचना व कार्यपध्दती",
    intro: "अहिल्यानगर जिल्ह्यामध्ये १४ पंचायत समित्या, आणि १३२३ ग्रामपंचायती आहेत.",
    points: [
...
const DOC_CATEGORIES: DocCategory[] = [
  {
    ...
    items: [
      {
        title: "जिल्हा परिषद अहिल्यानगर अंदाजपत्रक 2025-26",
  ...
  },
  {
    ...
    items: [
      {
        title: "कृषी विभाग-जिल्हा परिषद अहिल्यानगर",
        pdfFile: "CitizenCharter_Krushi.pdf",
      },
      {
        title: "जिल्हा परिषद अहिल्यानगर-नागरिकांची सनद",

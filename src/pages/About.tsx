...
export const Introduction = () => (
  <ContentPage title="प्रस्तावना" publishedDate="१५ मार्च २०२४">
    ...
    <p className="mb-4">
    अहिल्यानगर जिल्हा परिषदेची स्थापना दि. ०२ मे १९६२ रोजी झाली आहे. मा.अध्यक्ष व मा. उपाध्यक्ष व पदाधिकारी यांची दि. १२ ऑगस्ट १९६२ रोजी निवड होऊन जिल्हा परिषद अस्तित्वात आली.
    </p>
    <p>
...
export const VisionMission = () => (
  <ContentPage title="दृष्टी आणि ध्येय" publishedDate="१५ मार्च २०२४">
    ...
    <ul className="list-disc pl-6 space-y-2 mb-8">
      <li>अहिल्यानगर ग्रामीण क्षेत्रामध्ये मुलभुत सुविधा उपलब्ध होण्यासाठी तसेच स्वच्छ, सुंदर, व हरित ग्राम तयार करण्यासाठी विविध उपक्रम राबविणे.</li>
      ...
      <table className="w-full border-collapse border border-gray-200">
        ...
        <tbody>
          <tr className="hover:bg-gray-50 whitespace-nowrap">
            ...
            <td className="border p-3 text-sm">जिल्हा परिषद नवीन प्रशासकीय इमारत, दुसरा मजला, माळीवाडा एस.टी. स्टॅंड समोर, अहिल्यानगर - 414001</td>

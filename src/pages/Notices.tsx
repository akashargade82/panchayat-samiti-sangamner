...
const GHOSHNA_ITEMS: NoticeItem[] = [
  {
    title: "परिशिष्ट-८ (अ) – जिल्हा परिषदेच्या अंतिम विभागणीसाठी नमुना (पंचायत समिती संगमनेर)",

    description: "परिशिष्ट-८ (अ) – जिल्हा परिषदेच्या अंतिम विभागणीसाठी नमुना, पंचायत समिती संगमनेर",
...
const NIVIDA_ITEMS: NoticeItem[] = [
  {
    title: "जिल्हा परिषद, पंचायत समिती संगमनेर – आरोग्य विभाग (जिल्हा परीक्षण केंद्र) साठी प्रशिक्षण साहित्य, ऑफिस स्टेशनरी, छपाई व स्वच्छता साहित्य खरेदीसाठी अधिकृत दरपत्रके मागविण्याबाबत",

    description: "पंचायत समिती संगमनेर, आरोग्य विभाग (जिल्हा परीक्षण केंद्र) साठी प्रशिक्षण साहित्य, ऑफिस स्टेशनरी, छपाई व स्वच्छता साहित्य खरेदी करण्यासाठी अधिकृत दरपत्रके मागविण्याबाबत सूचना",
      ...
      <div className="flex flex-wrap gap-2 mb-6">
        {NOTICE_TABS.map((tab, idx) => (
          ...
          >
            {tab.label}
            {/* {tab.items.length > 0 && (
              <span className={`ml-2 px-1.5 py-0.5 rounded-full text-xs font-bold ${activeTab === idx ? 'bg-white/20 text-white' : 'bg-gray-100 text-gray-500'
                }`}>
                {tab.items.length}
              </span>
            )} */}
